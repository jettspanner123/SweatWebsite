...
export namespace ApplicationType {
    export interface MousePosition<PositionValueType> {
        x: PositionValueType;
        y: PositionValueType;
    }
...
export class ApplicationLinearGradient {
    ...
    appRedPinkGradient: string = `linear-gradient(to bottom, ${ApplicationColor.current.appRedLight} 0%, hotpink 100%)`;
